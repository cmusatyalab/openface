...
function SiamesePlusGlobalCriterion:__init(alpha)
    parent.__init(self)
...
function SiamesePlusGlobalCriterion:updateOutput(input)
...
function SiamesePlusGlobalCriterion:updateGradInput(input)
    local a = input[1] -- ancor
    local p = input[2] -- positive
    local n = input[3] -- negative
    local N = a:size(1)
