...
print(net:forward(a):size())
net:add(SpatialMaxPooling(5, 5, 2, 2)) -- 55 ->  27
print(net:forward(a):size())
...
print(net:forward(a):size())
net:add(SpatialMaxPooling(5, 5, 2, 2)) --  27 ->  13
print(net:forward(a):size())
...
print(net:forward(a):size())
net:add(nn.View(256 * 10 * 10)) --Changed
print(net:forward(a):size())
net:add(nn.Dropout(0.5))
print(net:forward(a):size())
net:add(nn.Linear(256 * 10 * 10, 4096)) --Changed
net:add(nn.ReLU(true))
