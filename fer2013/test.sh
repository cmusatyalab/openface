...
GAMO_DIR="$PWD/../gamo/data/aligned${imgDim}"
CIFE_DIR="$PWD/../cife/data/aligned${imgDim}"
FER_DIR="$PWD/../fer2013/data/aligned${imgDim}"
...
test_gamo ()
{
    if [ -f $RESULT_DIR/model_$1.t7 ] && [ ! -d $RESULT_DIR/rep-$1/gamo_train ]; then
        ../batch-represent/main.lua -batchSize 100 -model $RESULT_DIR/model_$1.t7  -cuda  \
            -data $GAMO_DIR/train -outDir $RESULT_DIR/rep-$1/gamo_train -imgDim $imgDim -channelSize 1 $2

        ../batch-represent/main.lua -batchSize 100 -model $RESULT_DIR/model_$1.t7  -cuda \
            -data $GAMO_DIR/test -outDir $RESULT_DIR/rep-$1/gamo_test -imgDim $imgDim -channelSize 1 $2
...
test_cife ()
{
    if [ -f $RESULT_DIR/model_$1.t7 ] && [ ! -d $RESULT_DIR/rep-$1/cife_train ]; then
        ../batch-represent/main.lua -batchSize 100 -model $RESULT_DIR/model_$1.t7 -cuda  \
            -data $CIFE_DIR/train -outDir $RESULT_DIR/rep-$1/cife_train -imgDim $imgDim -channelSize 1 $2

        ../batch-represent/main.lua -batchSize 100 -model $RESULT_DIR/model_$1.t7 -cuda  \
            -data $CIFE_DIR/test -outDir $RESULT_DIR/rep-$1/cife_test -imgDim $imgDim -channelSize 1 $2
...
test_fer ()
{
    ...
    ../batch-represent/main.lua -batchSize 100 -model $RESULT_DIR/model_$1.t7 -cuda \
        -data $FER_DIR/train -outDir $RESULT_DIR/rep-$1/fer2013_train -imgDim $imgDim -channelSize 1 $2

    ../batch-represent/main.lua -batchSize 100 -model $RESULT_DIR/model_$1.t7 -cuda \
        -data $FER_DIR/test -outDir $RESULT_DIR/rep-$1/fer2013_test -imgDim $imgDim -channelSize 1 $2
