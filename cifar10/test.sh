...
test_cifar10()
{
    ...
    if [ -f $RESULT_DIR/model_$1.t7 ] && [ ! -d $RESULT_DIR/rep-$1/train ]; then
        ...
        ../batch-represent/main.lua -batchSize 100 -model $RESULT_DIR/model_$1.t7 -cuda \
            -data $ALIGNED_DIR/train -outDir $RESULT_DIR/rep-$1/train -imgDim $imgDim -channelSize 3 $2
        ...
        python ../evaluation/classify.py --trainDir $RESULT_DIR/rep-$1/train \
            --testDir $RESULT_DIR/rep-$1/test --pathName cifar
    ...
    do
        ...
        do
            ...
            do
                ...
                do
                    RESULT_DIR="$WORK_DIR/results/raw_128/$i/$MODEL_NAME"
