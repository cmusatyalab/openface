...
train ()
{
    if [ ! -f $2/model_1.t7 ]; then
        th main.lua -data $ALIGNED_DIR/train -modelDef $1 -cache $WORK_DIR/data/cache  \
            ...
            -testDir $ALIGNED_DIR/test -testBatchSize 100 -epochSize 51 -nEpochs 30 -imgDim 64 -cuda -cudnn -criterion marginranking -alpha $3
...
do
    ...
    RESULT_DIR="$WORK_DIR/data/results_marginranking/nn4.small3/alpha$i"
...
#    RESULT_DIR="$WORK_DIR/data/results_marginranking/nn4.small2/alpha$i"
#    if [ ! -d $RESULT_DIR ]; then
#
#        train $MODEL $RESULT_DIR $i
#    fi
...
#    RESULT_DIR="$WORK_DIR/data/results_marginranking/nn4.small1/alpha$i"
#    if [ ! -d $RESULT_DIR ]; then
#
#        train $MODEL $RESULT_DIR $i
#    fi
...
#    RESULT_DIR="$WORK_DIR/data/results_marginranking/nn2/alpha$i"
#    if [ ! -d $RESULT_DIR ]; then
#
#        train $MODEL $RESULT_DIR $i
#    fi
...
#    RESULT_DIR="$WORK_DIR/data/results_marginranking/nn4/alpha$i"
#    if [ ! -d $RESULT_DIR ]; then
#
#        train $MODEL $RESULT_DIR $i
#    fi
...
#    RESULT_DIR="$WORK_DIR/data/results_marginranking/vgg/alpha$i"
#    if [ ! -d $RESULT_DIR ]; then
#
#        train $MODEL $RESULT_DIR $i
#    fi
...
#    RESULT_DIR="$WORK_DIR/data/results_marginranking/vgg.small1/alpha$i"
#    if [ ! -d $RESULT_DIR ]; then
#
#        train $MODEL $RESULT_DIR $i
#    fi
