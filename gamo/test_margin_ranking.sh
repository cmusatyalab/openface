...
do
    ...
    do
        ...
        RESULT_DIR="$WORK_DIR/data/results_margin_ranking/nn4.small3/alpha$i"
    
        test $j
    
        RESULT_DIR="$WORK_DIR/data/results_margin_ranking/nn4.small2/alpha$i"
    
        test $j
    
        RESULT_DIR="$WORK_DIR/data/results_margin_ranking/nn4.small1/alpha$i"
    
        test $j
    
        RESULT_DIR="$WORK_DIR/data/results_margin_ranking/nn2/alpha$i"
    
        test $j
    
        RESULT_DIR="$WORK_DIR/data/results_margin_ranking/nn4/alpha$i"
    
        test $j
    
        RESULT_DIR="$WORK_DIR/data/results_margin_ranking/vgg/alpha$i"
    
        test $j
    
        RESULT_DIR="$WORK_DIR/data/results_margin_ranking/vgg.small1/alpha$i"
