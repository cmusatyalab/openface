    ...
    do
        ...
        do
            ...
            do
                ...
                do
                    for i in t_entropy multi margin crossentropy s_cosine t_orj dist_ratio kldiv lmnn s_double_margin t_improved s_hadsell s_double_margin lmnn softPN lsss  histogram t_global
                    do
