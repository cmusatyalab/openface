...
test ()
{
   ...
   if [ -d $RESULT_DIR/rep-$1/train ] && [ ! -f $RESULT_DIR/rep-$1/train/svm_gamo_confusion.png ]; then
        python ../evaluation/classify.py --trainDir $RESULT_DIR/rep-$1/train \
...
for alg in  nn svm knn rf poly
do
    for num in 005 010 015 020 025 030
    do
        DATA_DIR="data_${num}_${imgDim}"
        ...
        do
            ...
            do
                ...
                do
                    for i in  lsss histogram t_entropy multi margin crossentropy s_cosine t_orj dist_ratio kldiv lmnn s_double_margin t_improved s_hadsell s_double_margin lmnn softPN lsss  histogram t_global
                    do
