...
test ()
{
   ...
   echo $RESULT_DIR/rep-$1 test
        timeout 600 python ../evaluation/classify.py --trainDir $RESULT_DIR/rep-$1/train \
    ...
    do
        ...
        do
            ...
            do
                ...
                do
                    for i in crossentropy t_orj s_cosine s_hadsell s_double_margin #histogram
                    do
