...
train ()
{
    if [ ! -f $2/model_1.t7 ]; then
        th main.lua -data $ALIGNED_DIR/train -modelDef $1 -cache $WORK_DIR/data/cache  \
            ...
            -testDir $ALIGNED_DIR/test -testBatchSize 100 -epochSize 51 -nEpochs 30 -imgDim 64 -cuda -cudnn -criterion l1hinge -alpha $3
...
do
    ...
    RESULT_DIR="$WORK_DIR/data/results_l1hinge/nn4.small3/alpha$i"
